...
* **Withdrawal assets:** The functionality is the same as [ETransfer UI SDK Withdraw Component](withdraw-component.md).
* **Querying historical records:** The functionality is the same as [ETransfer UI SDK History Component](history-component.md).
* **Viewing transaction details:** The functionality is the same as [ETransfer UI SDK Transfer Detail Component](transfer-detail-component.md).
